  ...
  return (
    ...
    >
      <select
        ...
        {...props}
      />
      <CaretDownIcon className="pointer-events-none absolute top-1/2 end-0 size-3.5 -translate-y-1/2 text-muted-foreground select-none" aria-hidden="true" data-slot="native-select-icon" />
    </div>
  )
}
